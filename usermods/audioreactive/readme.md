...
- `-D I2S_DINPIN=x` : GPIO for DIN (aka SD) pin on digital microphone (32)
- `-D I2S_DOUTPIN=x` : GPIO for DOUT pin for audio pass-through on boards with Line-In and Headphone Out (-1)
